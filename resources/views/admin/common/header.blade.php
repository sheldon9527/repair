<header class="main-header">
    ...
    <a href="javascript:;" class="logo">
        ...
        <span class="logo-mini"><b>北信校园故障报修系统</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>北信校园故障报修系统</b></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{app('admin')->user()->username}}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{url('/images/admin-avatar.jpg')}}" class="img-circle" alt="User Image" />
                            <p>{{app('admin')->user()->username}}</p>
                        </li>
                        <!-- Menu Footer-->
