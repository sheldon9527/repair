    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <a data-toggle="modal" data-target="#addRootModal" class="pull-right btn btn-success" type="button">添加报修类别</a>
            </div>
        </div>
        <div class="row">&nbsp;</div>
        <div class="row">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">添加报修类别</h4>
                </div>
