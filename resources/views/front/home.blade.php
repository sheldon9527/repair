...
<!--
			<tr onMouseOver="this.bgColor='#F0F7FF'" bgcolor="#FAFAFA" onMouseOut="this.bgColor='#FAFAFA'" style="margin-bottom:10px;">
				<td colspan="4">
					<table width="98%" cellpadding="0" cellspacing="5" align="center">
						<tr>
						  <td><b><span style="color:red;margin-right:10px">*</span>宿舍类型</b></td>
						</tr>
						<tr>
							<td>
								<div class="radio" style="margin-bottom:10px;">
									<label>
										<input type="radio" name="build_type" value="man" checked/> 男宿舍
									</label>
								</div>
								<div class="radio" style="margin-bottom:10px;margin-top:10px;">
									<label>
										<input type="radio" name="build_type" value="women" /> 女宿舍
									</label>
								</div>
							</td>
						</tr>
